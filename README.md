# break_eternity.js
A Javascript numerical library to represent numbers as large as 10^^1e308. If this is too ridiculous for your needs, check out break_infinity.js, my other library which maxes out at 1e1e308 ( https://github.com/Patashu/break_infinity.js ).
...
* Razenpok, slabdrill and Hevipelle/Antimatter Dimensions, for assistance and testing with the original break_infinity.js and its C# port ( https://github.com/Patashu/break_infinity.js ).
