...
var f_lambertw = function f_lambertw(z,tol = 1e-10) {
  var w;
  var wn;
...
var Decimal = /*#__PURE__*/function () {
  ...
  _createClass(Decimal, [{
    ...
    value: function fromString(value) {
      ...
      if (ptparts.length === 1) ptparts = value.split("PT");
      if (ptparts.length === 2) {
        base = 10;
      ...
      if (ptparts.length === 1) ptparts = value.split("P");
      if (ptparts.length === 2) {
        base = 10;
        height = parseFloat(ptparts[0]);
        ptparts[1] = ptparts[1].replace("(", "");
      ...
      if (ecount === 0) {
        ...
        if (isFinite(numberAttempt)) {
          ...
          if(value[0] === '-')return Decimal.fromString(value.substr(1)).mul(-1);
          var exponent = value.length - 1;
          var mantissa = value[0] + '.' + value.substr(1);
          this.fromMantissaExponent(parseFloat(mantissa),exponent);
          return this;
        }
      } else if (ecount === 1) {
